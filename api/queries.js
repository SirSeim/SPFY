...
var queries = {
    // changing this later, right now this code
    // erases data if the client already exists
    createClient: function (payload) {
        var queryString = 'INSERT INTO client (first_name, last_name, nickname) VALUES (';
